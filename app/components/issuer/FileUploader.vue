  ...
  <div>
    ...
    <div v-else class="border border-emerald-200 rounded-xl p-4 bg-emerald-50/30">
      <div class="flex items-center gap-3">
        ...
        <button class="text-xs text-emerald-600 hover:text-emerald-800 font-semibold px-3 py-1.5 hover:bg-emerald-100 rounded-lg transition-colors" @click="inputRef?.click()">
          Change
        </button>
      </div>
    </div>
