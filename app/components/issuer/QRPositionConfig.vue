    ...
    <template v-else>
      ...
      <div class="flex gap-4">
        <div class="relative w-40 h-52 bg-white border-2 border-gray-200 rounded-xl overflow-hidden shrink-0">
          ...
          <div :style="qrStyle" class="border-2 border-dashed border-emerald-500 bg-emerald-50 rounded flex items-center justify-center">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-1.5">
              <button
                ...
                :key="pos.value"
                class="px-2 py-1.5 text-xs rounded-lg border transition-all duration-200 font-medium"
